...
E_D=read.table("F:/Files from office/胶质瘤诱导分化组学数据分析/Code-cluster_based/Results/Differential Network Coefficient.txt")
E_D=as.matrix(E_D)
...
dev.new()
pheatmap(x,cluster_row=T, cluster_cols=T, clustering_distance_rows='euclidean',clustering_method = "ward", cellwidth = 0.05, cellheight = 5,color = colorRampPalette(c("CornflowerBlue", "white", "firebrick3"))(50), fontsize=9, fontsize_row=6,labRow=NA) #自定义颜色
